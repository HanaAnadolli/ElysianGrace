                    ...
                    <form method="POST" action="{{ route('category.store') }}" class="mt-6 space-y-6">
                        ...
                        <div class="bg-gray-800 p-5 rounded-lg">
                            <div class="mb-4">
                                ...
                                <x-text-input id="name" name="name" type="text" class="mt-1 block w-full bg-gray-700 text-white border-gray-600" required autofocus autocomplete="name" />
                            ...
                            <div class="mb-4">
                                ...
                                <x-rich-text-editor id="description" name="description" class="mt-1 block w-full bg-gray-700 text-white border-gray-600" />
