        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" action="{{ route('services.store') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
                        @csrf
                        <div class="bg-gray-800 p-5 rounded-lg">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea id="working_hours" name="working_hours" rows="4"
                                    class="mt-1 block w-full bg-gray-700 text-white border-gray-600 dark:bg-gray-900 dark:text-gray-100 dark:border-gray-700"
                                    placeholder="e.g., Monday to Friday: 08:00 - 22:00, Saturday: 10:00 - 20:00"></textarea>
                            ...
                            <!-- Submit Button -->
                            <x-submit-button value="Create Service" />
                        </div>
                    </form>
                </div>
            </div>
